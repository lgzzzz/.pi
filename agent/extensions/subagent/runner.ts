/**
 * Subprocess runner for the subagent extension
 *
...
/**
 * Determine how to invoke the `pi` process.
 */
 ...
 *
 * Streams progress via `onUpdate` if provided.
 */
    ...
    const exitCode = await new Promise<number>((resolve) => {
      ...
      const processLine = (line: string) => {
        ...
        if (event.type === "message_end" && event.message) {
          const msg = event.message as import("@earendil-works/pi-ai").Message;
        ...
        if (event.type === "tool_result_end" && event.message) {
          currentResult.messages.push(event.message as import("@earendil-works/pi-ai").Message);
          emitUpdate();
        }
      };
